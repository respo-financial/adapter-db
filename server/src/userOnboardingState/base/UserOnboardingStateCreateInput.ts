...
@InputType()
class UserOnboardingStateCreateInput {
  @ApiProperty({
    required: false,
    type: Boolean,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => UserDetailCreateNestedManyWithoutUserOnboardingStatesInput,
  })
  @ValidateNested()
  @Type(() => UserDetailCreateNestedManyWithoutUserOnboardingStatesInput)
  @IsOptional()
  @Field(() => UserDetailCreateNestedManyWithoutUserOnboardingStatesInput, {
    nullable: true,
  })
  userDetails?: UserDetailCreateNestedManyWithoutUserOnboardingStatesInput;
}

export { UserOnboardingStateCreateInput as UserOnboardingStateCreateInput };
