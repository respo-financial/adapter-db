...
@InputType()
class UserOnboardingStateUpdateInput {
  @ApiProperty({
    required: false,
    type: Boolean,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => UserDetailUpdateManyWithoutUserOnboardingStatesInput,
  })
  @ValidateNested()
  @Type(() => UserDetailUpdateManyWithoutUserOnboardingStatesInput)
  @IsOptional()
  @Field(() => UserDetailUpdateManyWithoutUserOnboardingStatesInput, {
    nullable: true,
  })
  userDetails?: UserDetailUpdateManyWithoutUserOnboardingStatesInput;
}

export { UserOnboardingStateUpdateInput as UserOnboardingStateUpdateInput };
