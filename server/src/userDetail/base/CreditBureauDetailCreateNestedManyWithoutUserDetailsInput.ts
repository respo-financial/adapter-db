...
@InputType()
class CreditBureauDetailCreateNestedManyWithoutUserDetailsInput {
...
export { CreditBureauDetailCreateNestedManyWithoutUserDetailsInput as CreditBureauDetailCreateNestedManyWithoutUserDetailsInput };
