import { UserDetailCreateNestedManyWithoutUserOnboardingStatesInput } from "./UserDetailCreateNestedManyWithoutUserOnboardingStatesInput";
...
export type UserOnboardingStateCreateInput = {
  ...
  userDetails?: UserDetailCreateNestedManyWithoutUserOnboardingStatesInput;
};
